...
const CreateProduct = () => {
    ...
    const createProduct = (e) => {
        ...
        console.log("clické");
        // const product = {
        //     categoryId ,name, slug, description, brand,
        //     sellingPrice, originalPrice, qty, image,
                            ...
                            <div className="tab-pane fade" id="other-detail" role="tabpanel" aria-labelledby="other">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-md-8 mb-2">
                                        ...
                                        <input type="file" className={errors.image ? "form-control border-danger" : "form-control"}
                                            onChange={(e)=>setImage(e.target.files[0])} id="image" />
